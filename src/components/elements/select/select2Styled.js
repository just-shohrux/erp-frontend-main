...
export const colourStyles = {
    control: (styles, { isDisabled, isFocused, isSelected, selectProps:{mode, checked, error} }) => ({ 
        ...styles, 
    ...
    menu: (styles, { selectProps:{mode, value} }) => ({
        ...styles,
        transition: "0.3s",
    ...
    option: (styles, { data, isDisabled, isFocused, isSelected, selectProps:{mode} }) => {
    ...
    input: (styles, { selectProps:{mode} }) => ({
        ...styles,
        fontWeight: "normal",
        fontSize: "12px",
        lineHeight: "12px"
    }),
    placeholder: (styles, { selectProps:{mode} }) => ({
        ...styles,
        fontWeight: "normal",
        fontSize: "12px",
        lineHeight: "12px"
    ...
    multiValue: (styles, { data:{color}, selectProps:{mode} }) => {
        let rgb = color.split("(")[0];
    ...
    multiValueLabel: (styles, { data:{color} }) => ({
        ...styles,
        color: color.split("(")[0] == "rgb" || color.split("(")[0] == "rgba" ? color : '#fff',
    }),
